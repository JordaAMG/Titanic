...
<div class="ingreso">
   ...
   <?php   require_once('Conexion (1).php'); 
...
?>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // Obtiene id de la materia que se selecciono
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // obtener el id de el alumno y de materia 
        if(isset($_POST["alumno_id"]) && isset($_POST["materia_id"])) {
            $alumno_id = $_POST["alumno_id"];
            $materia_id = $_POST["materia_id"];

            // recuperar del fomulario
