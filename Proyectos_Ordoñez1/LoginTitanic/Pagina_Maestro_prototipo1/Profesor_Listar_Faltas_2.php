            ...
            <article id="Acciones">
                <div id="Tabla0">
                    ...
                    <section id="Contenedor_Tabla">
                        <a id="Botones" href="Profesor_Listar_Faltas_3.php">Grupo 1</a><br><br><br>
                        <a id="Botones" href="Profesor_Listar_Faltas_3.php">Grupo 2</a><br><br><br>
                        <a id="Botones" href="Profesor_Listar_Faltas_3.php">Grupo 3</a><br><br><br>
                    </section>
                </div>
            </article>
        </section>    
