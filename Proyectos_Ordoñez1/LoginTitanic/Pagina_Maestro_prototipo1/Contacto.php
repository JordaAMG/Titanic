<?php
   ...
   Class Contacto extends Conexion{
      ...
      public function consultar_Grupos($matricula_profesor, $Materia_Elegida) {
         ...
         ON grupos.id_grupo = profesores_grupos.id_grupo
      ...
      /*public function Modificar_Calificaciones($alumno_id, $materia_id, $calificacion_parcial_1, $calificacion_parcial_2, $calificacion_parcial_3) {
         // Actualizar calificaciones existentes
         $this->sentencia = "UPDATE calificaciones SET parcial_uno = $calificacion_parcial_1, parcial_dos = $calificacion_parcial_2, parcial_tres = $calificacion_parcial_3 WHERE matricula_alumno = $alumno_id AND id_materia = $materia_id";
         $this->ejecutar_sentencia();
         return "¡Las calificaciones parciales se han modificado correctamente!";
      }*/
