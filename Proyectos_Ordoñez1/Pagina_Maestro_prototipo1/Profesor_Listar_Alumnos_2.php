    ...
    <div id="Prinsipal">
            ...
            <article id="Acciones">
                <div id="Tabla0">
                    ...
                    <section id="Contenedor_Tabla">
                        <a id="Botones" href="Profesor_Listar_Alumnos_3.php">Grupo 1</a><br><br><br>
                        <a id="Botones" href="Profesor_Listar_Alumnos_3.php">Grupo 2</a><br><br><br>
                        <a id="Botones" href="Profesor_Listar_Alumnos_3.php">Grupo 3</a><br><br><br>
                    </section>
                </div>
            </article>
        </section>    
        ...
        <?php
          if (isset($_GET["opc"])) {
            switch ($_GET["opc"]) {
                case 'Grupo_1':
                    include("Profesor_Listar_Alumnos_3.php");
                    break;
                case 'Grupo_2':
                    include("Profesor_Listar_Alumnos_3.php");
                    break;
