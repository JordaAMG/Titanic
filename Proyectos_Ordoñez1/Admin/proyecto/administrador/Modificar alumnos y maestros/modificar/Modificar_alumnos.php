    ...
    <select name="idmodificar">
        ...
        if ($resultado) {
            while ($registro = $resultado->fetch_assoc()) {
                //selected Mantiene el registro seleccionado para que no haya errores
...
if (isset($_POST["modificar"])) {
    ...
    if (isset($_POST['matricula_alumno'], $_POST['nombre_completo'], $_POST['correo'], $_POST['contraseña'], $_POST['id_semestre'])) {
